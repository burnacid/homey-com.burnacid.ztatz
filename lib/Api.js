...
class Api {
    ...
    async testConnection(domain = null) {
    ...
    async getSmartmeter(domain = null) {
    ...
    async getWatermeter(domain = null) {
        this.command = '/api/v1/watermeter/hour?limit=1';
    ...
    async getFinancialDay(domain = null) {
    ...
    async getFinancialMonth(domain = null) {
    ...
    async getPowerGasDay(domain = null) {
    ...
    async getWaterDay(domain = null) {
        this.command = '/api/v1/watermeter/day?json=object&limit=1';
